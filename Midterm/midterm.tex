...
\item Abstraction
  ...
  \item While working on a design, we implement only the parts we understand and are the components required for the document to give the 
...
The SetOfInt module is not consistent because it does not follow uniform name conventions. For example, if the Boolean functions were being named is_member, then empty and equals 
shouldve been named is_empty and is_equals.
